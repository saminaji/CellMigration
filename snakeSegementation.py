...
def chanvese(I, init_mask, max_its=200, alpha=0.1,
...
if __name__ == "__main__":
    img = nd.imread('/home/sami/Desktop/optflow/tr_0.png', flatten=True)
    mask = np.zeros(img.shape)
    mask[20:850, 20:850] = 1

    chanvese(img, mask, max_its=13000, display=True, alpha=0.05)