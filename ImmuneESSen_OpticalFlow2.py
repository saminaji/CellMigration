...
def watershed_segmentation(image):
    ...
    #adj = neighbors.kneighbors_graph(labels, 4)
    #print adj
    ...
    for label in np.unique(markers):
        ...
        # imageshow = np.stack([old_frame, old_gray_image])
